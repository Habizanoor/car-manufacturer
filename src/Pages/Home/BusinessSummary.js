...
const BusinessSummary = () => {
    return (
        <div>
            <h2 className='text-2xl font-bold text-center mb-5'>Business Summary</h2>
            <div className='flex justify-center'>
                <div className="stats shadow">
                    ...
                    <div className="stat">
                        <div clasNames="stat-figure text-secondary">
                        ...
                        <div className="stat-title">World Wide Purchase</div>
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-title">International Purchase</div>
