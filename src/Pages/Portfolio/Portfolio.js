    ...
    return (
        <div className="card w-auto bg-base-100 shadow-xl mx-auto mt-10">
            <div className="card-body">
                ...
                <p><span className='font-bold'>skills:</span> html, html5, css, css3, bootstrap, tailwind, javascript, dom, ES6, react, firebase authentication, react router, daisyUi, node.js express.js, mongodb, firebase, git, netlify,   </p>
